  ...
  return (
    <section className="w-full px-20 py-12 bg-gray-50">
      <div className="flex flex-col lg:flex-row gap-8">
        {/* CARD 1 */}
        <div className="flex-1 w-[360px] h-[284px] bg-white rounded-2xl shadow p-4 border border-gray-100">
 ...
 <div className="overflow-x-auto relative">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td className="py-2 pl-4 w-1/2">
          ...
          <p className="text-gray-500 mt-2 text-sm">Trade safely with fully verified companies.
          </p>
        </div>

        {/* CARD 2 */}
        <div className="flex-1 bg-white w-[360px] h-[284px] rounded-2xl shadow p-6 border border-gray-100">
          {/* Logo + Label */}
          <div className="flex items-center gap-3 mb-4">
            {/* <Image src="/report.svg" alt="Report" width={28} height={28} /> */}
  ...
  <div className="shadow rounded-xl px-4 bg-white">
    <div className="flex items-center gap-3">
      <span className="text-sm font-medium text-gray-500 pl-4 pt-2">Top Bids</span>
    </div>
    ...
    <div className="flex mt-2 justify-start items-center w-full border-t border-[#E1E1E1] h-32">
      <ResponsiveContainer width="98%" height="100%">
        <BarChart
          layout="vertical"
          data={data}
          margin={{ top: -4, right: -15, left: -43, bottom: 5 }} className="py-2"
        >
